...
@section('content')
    <div>
        <ol class="flex text-gray-500 font-semibold dark:text-white-dark">
            ...
            <li  class="before:content-['/'] before:px-1.5"><a href="javascript:history.back();">Liste des frets introduits</a></li>
            <li class="before:content-['/'] before:px-1.5"><a href="" class="text-warning dark:text-white-light hover:text-black/70 dark:hover:text-white-light/70">Liste des propositions</a></li>
        </ol>

        <div class="pt-5">
            <div class="panel">
                <div class="mb-5 flex items-center justify-center">
                    <h5 id="numero1Fret" class="text-lg font-semibold dark:text-white-light"></h5>
                </div>
                ...
                <div class="mb-5">
                    <div class="mb-5 flex items-end justify-end">
                       <a id="btnFaireProposition" href="javascript:void(0);" class="btn btn-warning disabled opacity-50 pointer-events-none" onclick="showAlertStart('$keyfret')">
...
@include('v1.transporteur.page.fret.modal') <!-- Pour les deux fenêtres modales (Faire une proposition et afficher raison refus)-->
