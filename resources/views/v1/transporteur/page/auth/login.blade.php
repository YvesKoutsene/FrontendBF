                ...
                <div
                    ...
                    <div class="relative hidden w-full items-center justify-center bg-warning p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-32 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                        ...
                        <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                            <a href="" class="hidden w-full max-w-[430px] lg:block">
                    ...
                    <div
                        ...
                        <div class="w-full max-w-[440px] lg:mt-16">
                            ...
                            <form id="login-form" class="space-y-5 dark:text-white">
                                ...
                                <div>
                                    <label class="flex cursor-pointer items-center">
                                        ...
                                        <span class="text-white-dark">Se rappeler de moi</span>
                                    </label>
                                </div>

                                <button id="login-btn" type="submit" class="btn btn-warning !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)] relative flex items-center justify-center gap-2">
                                  <svg id="login-spinner" viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="relative my-7 text-center md:mb-9">
                                ...
                                <span
                                    class="relative bg-white px-2 font-bold uppercase text-white-dark dark:bg-dark dark:text-white-light">Ou</span>
                            </div>
